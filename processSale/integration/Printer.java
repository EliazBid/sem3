...
public class Printer {
    ...
    * Creates an instance of the printer.
	...
	public void printReceipt(Receipt receipt) {
		...
		System.out.println("The total is: " + String.format("%.2f", receipt.getRunningTotal().getAmountInDouble()));
		System.out.println("The change is: " + String.format("%.2f", receipt.getChange().getAmountInDouble()));
